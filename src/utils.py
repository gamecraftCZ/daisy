...
# TODO configure_optimizer_wm_ncp_single
def configure_optimizer_wm_ncp_single(model, learning_rate, weight_decay, *blacklist_module_names):
    # """Credits to https://github.com/karpathy/minGPT"""
    # separate out all parameters to those that will and won't experience regularizing weight decay
    # decay = set()
    # no_decay = set()
...
# TODO configure_optimizer_wm_ncp_multiple
def configure_optimizer_wm_ncp_multiple(model, learning_rate, weight_decay, *blacklist_module_names):
    # """Credits to https://github.com/karpathy/minGPT"""
    # separate out all parameters to those that will and won't experience regularizing weight decay
    # decay = set()
    # no_decay = set()
